...
if ($category) {
    // API call setup
    $api_url = "https://prodhanltd.com/api/category_wise_prodict.php";
                    ...
                    <?php if (!empty($products)): ?>
                        <?php foreach ($products as $product): ?>
                            <?php
                                ...
                                $productImage = 'https://prodhanltd.com/' . $product['Image'];
                                $productPrice = $product['Price'];
                                $productPoint = $product['point'];
                            ?>
                            <div class="col-md-3 col-sm-6 product-box">
                                <div class="product shadow-sm p-3 mb-5 bg-white rounded">
                                    <figure class="product-media">
                                        <img src="<?= htmlspecialchars($productImage) ?>" alt="<?= htmlspecialchars($productTitle) ?>" class="img-fluid" />
                                    </figure>
                                    <div class="product-details mt-2">
                                        <h5 class="product-title"><?= htmlspecialchars($productTitle) ?></h5>
                                        <p class="product-price">৳ <?= number_format($productPrice) ?></p>
                                        <p class="product-point">Reward Point: <?= $productPoint ?></p>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p class="text-danger">No products found for this category.</p>
                    <?php endif; ?>
                </div>
